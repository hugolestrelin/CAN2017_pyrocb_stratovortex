...
textstr=str(track_model3['dates'][itrack].year)+'/0'+str(track_model3['dates'][itrack].month)+'/'+str(track_model3['dates'][itrack].day)+'\n'r'$\theta$ = '+str(int(PTref))+' K'
...
gl.xlabel_style = {'size': fs}
gl.ylabel_style = {'size': fs}
textstr=str(track_model3['dates'][itrack].year)+'/0'+str(track_model3['dates'][itrack].month)+'/0'+str(track_model3['dates'][itrack].day)+'\n'r'$\theta$ = '+str(int(PTref))+' K'
